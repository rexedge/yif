...
import type { Event, EventTicketTier } from "@/generated/prisma/client";
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg bg-white/5 border border-white/10 px-3 py-2 text-sm text-white outline-none focus:border-[var(--yif-gold)]/30"
                />
              </div>
              <div>
                <label className="block text-xs text-white/40 mb-1">
      ...
      <div className="rounded-2xl bg-white/5 border border-white/8 p-6">
        ...
        <div className="flex items-center gap-4">
          {[
            ...
            { value: "true", label: "Published", desc: "Visible on /events" },
          ].map((opt) => (
            <label
              key={opt.value}
            ...
            >
              <input
                ...
                value={opt.value}
                defaultChecked={
                  opt.value === (event.isPublished ? "true" : "false")
                }
                className="sr-only"
              />
